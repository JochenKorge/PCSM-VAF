# Application details
$appFilePath = "bin\Debug\MyCompany.MyProduct.MyVaultApplication1.mfappx"
$appGuid = "f02dba99-b2c7-4ff2-8235-01b82d64ed5c"
...
try
{
	Write-Host "Checking for previous installation of MyCompany.MyProduct.MyVaultApplication1..."
...
Write-Host "Installing MyCompany.MyProduct.MyVaultApplication1..."
